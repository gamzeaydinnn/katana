        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TaxNo = table.Column<string>(type: "nvarchar(11)", maxLength: 11, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FailedRecordsCount = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TargetValue = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    IntegrationLogId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 9, 25, 17, 21, 54, 951, DateTimeKind.Utc).AddTicks(2152), null, "Default account code for unmapped products", true, "SKU_ACCOUNT", "DEFAULT", "600.01", new DateTime(2025, 9, 25, 17, 21, 54, 951, DateTimeKind.Utc).AddTicks(2153), null },
                    { 2, new DateTime(2025, 9, 25, 17, 21, 54, 951, DateTimeKind.Utc).AddTicks(2155), null, "Default warehouse code for unmapped locations", true, "LOCATION_WAREHOUSE", "DEFAULT", "MAIN", new DateTime(2025, 9, 25, 17, 21, 54, 951, DateTimeKind.Utc).AddTicks(2156), null }
                });

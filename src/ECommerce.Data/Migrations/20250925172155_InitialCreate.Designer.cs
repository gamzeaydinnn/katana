...
namespace ECommerce.Data.Migrations
{
    ...
    [Migration("20250925172155_InitialCreate")]
            ...
            modelBuilder.Entity("ECommerce.Data.Models.MappingTable", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 9, 25, 17, 21, 54, 951, DateTimeKind.Utc).AddTicks(2152),
                            Description = "Default account code for unmapped products",
                            IsActive = true,
                            MappingType = "SKU_ACCOUNT",
                            SourceValue = "DEFAULT",
                            TargetValue = "600.01",
                            UpdatedAt = new DateTime(2025, 9, 25, 17, 21, 54, 951, DateTimeKind.Utc).AddTicks(2153)
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2025, 9, 25, 17, 21, 54, 951, DateTimeKind.Utc).AddTicks(2155),
                            Description = "Default warehouse code for unmapped locations",
                            IsActive = true,
                            MappingType = "LOCATION_WAREHOUSE",
                            SourceValue = "DEFAULT",
                            TargetValue = "MAIN",
                            UpdatedAt = new DateTime(2025, 9, 25, 17, 21, 54, 951, DateTimeKind.Utc).AddTicks(2156)
                        });
                });

...
//ETL akışının orchestration’ı, UnitOfWork, transaction, audit log, publish events.
public class SyncService : ISyncService
{
    ...
    Task<SyncResultDto> ISyncService.SyncStockAsync(DateTime? fromDate)
    {
        throw new NotImplementedException();
    }

    Task<SyncResultDto> ISyncService.SyncInvoicesAsync(DateTime? fromDate)
    {
        throw new NotImplementedException();
    }

    Task<SyncResultDto> ISyncService.SyncCustomersAsync(DateTime? fromDate)
    {
        throw new NotImplementedException();
    }

    Task<BatchSyncResultDto> ISyncService.SyncAllAsync(DateTime? fromDate)
    {
        throw new NotImplementedException();
    }

    Task<List<SyncStatusDto>> ISyncService.GetSyncStatusAsync()
    {
        throw new NotImplementedException();
    }
}

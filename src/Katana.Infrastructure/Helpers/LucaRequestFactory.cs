...
public static class LucaRequestFactory
{
        ...
        double kdvOran = 0.18)
    {
        var header = new LucaCreateInvoiceHeaderRequest
        {
            ...
            BelgeTarihi = (belgeTarihi ?? DateTime.UtcNow).ToString("dd/MM/yyyy"),
            ...
            FaturaTur = faturaTur.ToString(),
            CariKodu = cariKodu,
            MusteriTedarikci = musteriTedarikci.ToString(),

...
jest.mock("./components/StockManagement/StockManagement", () => () => <div>StockManagement</div>);
jest.mock("./components/SyncManagement/SyncManagement", () => () => <div>SyncManagement</div>);
jest.mock("./components/Reports/Reports", () => () => <div>Reports</div>);
jest.mock("./components/Settings/Settings", () => () => <div>Settings</div>);
jest.mock("./components/AdminPanel/AdminPanel", () => () => <div>AdminPanel</div>);
jest.mock("./components/Luca/BranchSelector", () => () => <div>BranchSelector</div>);

-- Migration: Add missing Luca sync fields to Products table
-- Date: 2025-12-21
...
--              Note: LucaId already exists, so we skip it
...
ELSE
BEGIN
    PRINT 'KategoriAgacKod column already exists in Products table';
END
GO
...
ELSE
BEGIN
    PRINT 'PurchasePrice column already exists in Products table';
END
GO
...
ELSE
BEGIN
    PRINT 'GtipCode column already exists in Products table';
END
GO
...
ELSE
BEGIN
    PRINT 'UzunAdi column already exists in Products table';
END
GO

PRINT 'Migration completed: Missing Luca sync fields added to Products table';